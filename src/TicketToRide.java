public class TicketToRide extends BoardGames {
    private int numRounds;

    TicketToRide(String name, int numPlayers, int maxPlayers, int year, double price, int avgPlaytime, double avgRating,
